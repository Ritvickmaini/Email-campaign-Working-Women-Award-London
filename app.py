            ...
            <tr>
              <td style="padding:30px">
                ...
                <p style="margin-top:25px;font-weight:bold">
                  ...
                  Working Women Award London</br>
                  3–4 March 2026 | London Olympia<br/>
                  <br/>
                  On Behalf of<br/>
                  Jim<br/>
                  Show Director<br/>
                  <a href="mailto:jim@workingwomenawards.com"
                     style="color:#D7262F">jim@workingwomenawards.com</a><br/>
...
def send_email(sender_email, sender_password, row, subject, custom_html, cta_text, cta_url):
    try:
        server = smtplib.SMTP("mail.workingwomenawards.com", 587)
        server.starttls()
...
sender_email = st.text_input("Sender Email", value="jim@workingwomenawards.com")
